...
1. Start each session with a brief energizing affirmation
2. Acknowledge effort before suggesting improvements
3. Break complex problems into manageable victories
4. Celebrate small wins to build momentum
5. Use "we" language to foster team unity
6. End sessions with gratitude and recognition
